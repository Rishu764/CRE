...
import { ArrowLeft, ExternalLink, Calendar, Tag, Quote, CheckCircle, AlertCircle } from "lucide-react";

export const metadata: Metadata = {
  title: "उत्तराखंड समता पार्टी के अध्यक्ष डॉ. वीके बहुगुणा का इस्तीफा – CRE",
  description:
    "डॉ. वी.के. बहुगुणा ने 8 जुलाई 2026 को उत्तराखंड समता पार्टी के अध्यक्ष पद से इस्तीफा दिया। उन्होंने CRE और जन विकास मंच के माध्यम से काम जारी रखने का संकल्प दोहराया।",
};
    ...
    <main className="min-h-screen bg-[#fafaf8]">
      ...
      <div className="pt-20 bg-white border-b border-gray-100">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 py-5 flex items-center justify-between gap-4">
          ...
          <span className="text-xs text-gray-400 uppercase tracking-widest font-medium">News · Politics</span>
        </div>
      </div>
      ...
      <div className="bg-[#1b4332] text-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 py-16 sm:py-20">
          <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[11px] font-bold uppercase tracking-widest bg-[#52b788]/20 border border-[#52b788]/30 text-[#52b788] mb-8">
            <Tag className="w-3 h-3" />नेतृत्व अपडेट
          </span>
      ...
      <article className="max-w-3xl mx-auto px-4 sm:px-6 py-14 space-y-10">
        ...
        <div className="space-y-5">
          <p className="text-[17px] leading-[1.9] text-gray-700 first-letter:text-5xl first-letter:font-black first-letter:text-[#1b4332] first-letter:float-left first-letter:mr-2 first-letter:leading-none first-letter:mt-1">
        ...
        <div className="space-y-4">
          <h2 className="text-2xl font-black text-gray-900">इस्तीफे में क्या बोले डॉ. वीके बहुगुणा?</h2>
          <p className="text-[17px] leading-[1.9] text-gray-700">
        ...
        <div className="rounded-2xl border border-red-100 bg-red-50/50 p-6 sm:p-8">
          <div className="flex items-center gap-2 mb-5">
            ...
            <h3 className="text-lg font-black text-gray-900">संगठनात्मक कमजोरी — इस्तीफे की प्रमुख वजहें</h3>
          </div>
          <ul className="space-y-3">
            {resignationReasons.map((reason, i) => (
              <li key={i} className="flex items-start gap-3 text-sm text-gray-700 leading-relaxed">
                <span className="shrink-0 w-5 h-5 rounded-full bg-red-100 text-red-500 text-xs font-black flex items-center justify-center mt-0.5">{i + 1}</span>
                {reason}
              </li>
            ))}
          </ul>
        ...
        {/* Achievements */}
        <div className="space-y-4">
          <h2 className="text-2xl font-black text-gray-900">किन मुद्दों को बताया अपनी उपलब्धि?</h2>
          <p className="text-[17px] leading-[1.9] text-gray-700">
        ...
        {/* What next */}
        <div className="space-y-4">
          <h2 className="text-2xl font-black text-gray-900">अब क्या करेंगे डॉ. वीके बहुगुणा?</h2>
          <p className="text-[17px] leading-[1.9] text-gray-700">
            डॉ. बहुगुणा ने स्पष्ट किया है कि वे सार्वजनिक जीवन से अलग नहीं हो रहे हैं। उन्होंने कहा कि अब वे{" "}
            <strong className="text-[#1b4332]">सेंटर फॉर रिसोर्स मैनेजमेंट एंड एनवायरमेंट (CRE)</strong>{" "}
            तथा{" "}
            <strong className="text-[#1b4332]">उत्तराखंड जन विकास मंच</strong>{" "}
            जैसे सामाजिक संगठनों के माध्यम से पर्यावरण संरक्षण, सुशासन, संतुलित विकास और उत्तराखंड के लोगों के अधिकारों के लिए काम करते रहेंगे।
          </p>
          <p className="text-[17px] leading-[1.9] text-gray-700">
        ...
        {/* Political impact */}
        <div className="space-y-4">
          <h2 className="text-2xl font-black text-gray-900">चुनाव से पहले क्या होगा राजनीतिक असर?</h2>
          <p className="text-[17px] leading-[1.9] text-gray-700">
        ...
        {/* Conclusion */}
        <div className="space-y-4">
          <h2 className="text-2xl font-black text-gray-900">निष्कर्ष</h2>
          <p className="text-[17px] leading-[1.9] text-gray-700">
        ...
        <div className="rounded-xl border border-gray-200 bg-white p-5 flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-gray-400 mt-1">प्रकाशित 8 जुलाई 2026</p>
          </div>
        </div>
